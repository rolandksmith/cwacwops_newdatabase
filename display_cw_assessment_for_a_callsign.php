function display_cw_assessment_for_a_callsign_func() {
...
/*
	...
	5Nov24 Forked from view a student assessment by Roland
*/
...
/// get the time that the process started
	...
	$strPass					= "1";
	$theURL						= "$siteURL/cwa-display-cw-assessment-for-a-callsign/";
	$inp_semester				= '';
	$inp_rsave					= '';
	$inp_callsign				= '';
	$advisor_call_sign			= '';
	$advisorCheck				= FALSE;
	$versionNumber				= '3';
	$jobname					= "Display CW Assessment for a Callsign V$versionNumber";
	$token						= '';
	$inp_advisor				= '';
	$inp_token					= '';
...
add_shortcode ('display_cw_assessment_for_a_callsign', 'display_cw_assessment_for_a_callsign_func');
