...
td,th{text-align:center;}
	...
	if ("1" == $strPass) {
		...
		$content 		.= "<h3>Student and Advisor Statistics (Color Chart)</h3>
...
///// Pass 2 -- do the work
		...
		if ($doDebug) {
			echo "At pass 2 with students: $inp_students, advisors: $inp_advisors, and semester: $inp_semester<br />";
		}
...
// display the chart
			...
			$content			.= "<h3>NEW Student and Advisor Color Chart</h3>
									...
									<p>All times are in UTC and are in one-hour chunks. For example, the UTC time 
...
//			}
			...
			foreach($classOptionsArray as $myValue) {
				...
				$content		.= "<tr><td>$myStr</td>
										<td>$thisTime</td>
										<td>$thisDays<br />$advisorList</td>
										<td>$thisCount</td></tr></tr>";
			}
			$content			.= "</table>";
		}
