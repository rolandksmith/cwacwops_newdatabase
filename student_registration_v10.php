function student_registration_v10_func() {
...
///////////////// pass 100
		...
		if ($doProceed) {
			...
			$content				.= "<p>CW Academy offers four levels of classes based upon operator CW proficiency: 
										...
										<p>Classes are eight weeks long and are conducted three times each year 
										in January - February, May - June and September - October. During that time classes 
										meet twice a week for an hour.</p>
...
add_shortcode ('student_registration_v10', 'student_registration_v10_func');
