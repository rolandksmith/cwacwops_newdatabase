function search_old_audit_log_func() {
	
/*	Search and Display Old Audit Log Data
...
/// get the time that the process started
	...
	$inp_log					= '';
	$inp_callsign				= '';
	$theURL						= "$siteURL/cwa-search-old-audit-log/";
	$filename					= '';
	$displayCount				= 0;
	$inp_verbose				= '';
...
$headerArray	= array(
	...
	if ($testMode) {
		$auditLogTableName		= 'wpw1_cwa_old_audit_log2';
	} else {
		$auditLogTableName		= 'wpw1_cwa_old_audit_log';
	}
...
add_shortcode ('search_old_audit_log','search_old_audit_log_func');
