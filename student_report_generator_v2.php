function student_report_generator_v2_func() {
...
/// get the time that the process started
	...
	$catalog_options			= '';
	$flexible					= '';
	$theURL						= "$siteURL/cwa-student-report-generator-v2/";
	$inp_config					= 'N';
	$inp_report_name			= '';
	$reportConfig				= array();
	$rg_config					= '';
...
// set the variables to unchecked
	$action_log_checked					= '';
	$advisor_checked					= '';
	$advisor_select_date_checked		= '';
	$age_checked						= '';
	$assigned_advisor_checked			= '';
	$advisor_class_timezone_checked		= '';
	$call_sign_checked					= '';
	$city_checked						= '';
	$class_priority_checked				= '';
	$assigned_advisor_class_checked		= '';
	$email_checked						= '';
	$email_number_checked				= '';
	$excluded_advisor_checked			= '';
	$first_name_checked					= '';
	$hold_override_checked				= '';
	$hold_reason_code_checked			= '';
	$id_checked							= '';
	$intervention_required_checked		= '';
	$last_name_checked					= '';
	$level_checked						= '';
	$mode_type_checked					= '';
	$notes_checked						= '';
	$email_sent_date_checked			= '';
	$orderby_checked					= '';
	$output_type_checked				= '';
	$passed_over_count_checked			= '';
	$phone_checked						= '';
	$promotable_checked					= '';
	$request_date_checked				= '';
	$response_checked					= '';
	$response_date_checked				= '';
	$abandoned_checked					= '';
	$selected_date_checked				= '';
	$semester_checked					= '';
	$state_checked						= '';
	$messaging_checked					= '';
	$student_status_checked				= '';
	$student_survey_completion_date_checked		= '';
	$testconditions_checked				= '';
	$time_zone_checked					= '';
	$available_class_days_checked		= '';
	$welcome_date_checked				= '';
	$where_checked						= '';
	$wpm_checked						= '';
	$youth_checked						= '';
	$parent_checked						= '';
	$parent_email_checked				= '';
	$country_checked					= '';
	$firstTime							= TRUE;
	$myCount							= 0;
	$inp_report							= '';
	$zip_code_checked					= '';
	$start_time_checked					= '';
	$first_class_choice_checked			= '';
	$second_class_choice_checked		= '';
	$third_class_choice_checked			= '';
	$first_class_choice_utc_checked		= '';
	$second_class_choice_utc_checked	= '';
	$third_class_choice_utc_checked		= '';
	$date_created_checked				= '';
	$date_updated_checked				= '';
	$ph_code_checked					= '';
	$country_code_checked				= '';
	$timezone_id_checked				= '';
	$timezone_offset_checked			= '';
	$whatsapp_checked					= '';
	$signal_checked						= '';
	$telegram_checked					= '';
	$messenger_checked					= '';
	$waiting_list_checked				= '';
	$no_catalog_checked					= '';
	$copy_control_checked				= '';
	$catalog_options_checked			= '';
	$flexible_checked					= '';
	$pre_assigned_advisor_checked		= '';
	$table_checked						= 'checked';
	$comma_checked						= '';
	
	$thisWhere							= '';
	$thisOrderby						= 'call_sign';
...
<tr><td><input type='checkbox' id='id' name='id' value='id' $id_checked> ID</td><td>id</td></tr>
<tr><td><input type='checkbox' id='call_sign' name='call_sign' value='call_sign' $call_sign_checked> Student Call Sign</td><td>call_sign</td></tr>
<tr><td><input type='checkbox' id='first_name' name='first_name' value='first_name' $first_name_checked> First Name</td><td>first_name</td></tr>
<tr><td><input type='checkbox' id='last_name' name='last_name' value='last_name' $last_name_checked> Last Name</td><td>last_name</td></tr>
<tr><td><input type='checkbox' id='email' name='email' value='email' $email_checked> Email</td><td>email</td></tr>
<tr><td><input type='checkbox' id='ph_code' name='ph_code' value='ph_code' $ph_code_checked> Ph Code</td><td>ph_code</td></tr>
<tr><td><input type='checkbox' id='phone' name='phone' value='phone' $phone_checked> Phone</td><td>phone</td></tr>
<tr><td><input type='checkbox' id='city' name='city' value='city' $city_checked> City</td><td>city</td></tr>
<tr><td><input type='checkbox' id='state' name='state' value='state' $state_checked> State</td><td>state</td></tr>
<tr><td><input type='checkbox' id='zip_code' name='zip_code' value='zip_code' $zip_code_checked> Zip or Postal Code</td><td>zip_code</td></tr>
<tr><td><input type='checkbox' id='country_code' name='country_code' value='country_code' $country_code_checked> Country Code</td><td>country_code</td></tr>
<tr><td><input type='checkbox' id='country' name='country' value='country' $country_checked> Country</td><td>country</td></tr>
<tr><td><input type='checkbox' id='time_zone' name='time_zone' value='time_zone' $time_zone_checked> Time Zone</td><td>time_zone</td></tr>
<tr><td><input type='checkbox' id='timezone_id' name='timezone_id' value='timezone_id' $timezone_id_checked> Timezone ID</td><td>timezone_id</td></tr>
<tr><td><input type='checkbox' id='timezone_offset' name='timezone_offset' value='timezone_offset' $timezone_offset_checked> Timezone Offset</td><td>timezone_offset</td></tr>
<tr><td><input type='checkbox' id='whatsapp' name='whatsapp' value='whatsapp' $whatsapp_checked> Whatsapp</td><td>whatsapp</td></tr>
<tr><td><input type='checkbox' id='signal' name='signal' value='signal' $signal_checked> Signal</td><td>signal</td></tr>
<tr><td><input type='checkbox' id='telegram' name='telegram' value='telegram' $telegram_checked> Telegram</td><td>telegram</td></tr>
<tr><td><input type='checkbox' id='messenger' name='messenger' value='messenger' $messenger_checked> Messenger</td><td>messenger</td></tr>
<tr><td><input type='checkbox' id='wpm' name='wpm' value='wpm' $wpm_checked> WPM</td><td>wpm (not used)</td></tr>
<tr><td><input type='checkbox' id='youth' name='youth' value='youth' $youth_checked> Youth</td><td>youth</td></tr>
<tr><td><input type='checkbox' id='age' name='age' value='age' $age_checked> Age</td><td>age</td></tr>
<tr><td><input type='checkbox' id='parent' name='parent' value='parent' $parent_checked> Student Parent</td><td>student_parent</td></tr>
<tr><td><input type='checkbox' id='parent_email' name='parent_email' value='parent_email' $parent_email_checked> Student Parent Email</td><td>student_parent_email</td></tr>
<tr><td><input type='checkbox' id='level' name='level' value='level' $level_checked> Level</td><td>level</td></tr>
<tr><td><input type='checkbox' id='waiting_list' name='waiting_list' value='waiting_list' $waiting_list_checked> Waiting List</td><td>waiting_list</td></tr>
<tr><td><input type='checkbox' id='request_date' name='request_date' value='request_date' $request_date_checked> Request Date</td><td>request_date </td></tr>
<tr><td><input type='checkbox' id='semester' name='semester' value='semester' $semester_checked> Semester</td><td>semester</td></tr>
<tr><td><input type='checkbox' id='notes' name='notes' value='notes' $notes_checked> Notes</td><td>notes</td></tr>
<tr><td><input type='checkbox' id='email_sent_date' name='email_sent_date' value='email_sent_date' $email_sent_date_checked> Email Sent Date</td><td>email_sent_date </td></tr>
<tr><td><input type='checkbox' id='email_number' name='email_number' value='email_number' $email_number_checked> Email Number</td><td>email_number</td></tr>
<tr><td><input type='checkbox' id='response' name='response' value='response' $response_checked> Response</td><td>response</td></tr>
<tr><td><input type='checkbox' id='response_date' name='response_date' value='response_date' $response_date_checked> Response Date</td><td>response_date </td></tr>
<tr><td><input type='checkbox' id='abandoned' name='abandoned' value='abandoned' $abandoned_checked> Abandoned</td><td>abandoned</td></tr>
<tr><td><input type='checkbox' id='student_status' name='student_status' value='student_status $student_status_checked'> Student Status</td><td>student_status</td></tr>
<tr><td><input type='checkbox' id='action_log' name='action_log' value='action_log' $action_log_checked> Action Log</td><td>action_log</td></tr>
<tr><td><input type='checkbox' id='theadvisor' name='theadvisor' value='theadvisor' $pre_assigned_advisor_checked> Pre-assigned advisor</td><td>pre_assigned_advisor</td></tr>
<tr><td><input type='checkbox' id='selected_date' name='selected_date' value='selected_date' $selected_date_checked> Selected Date</td><td>selected_date </td></tr>
<tr><td><input type='checkbox' id='welcome_date' name='welcome_date' value='welcome_date' $welcome_date_checked> Welcome Date</td><td>wlcome_date </td></tr>
<tr><td><input type='checkbox' id='no_catalog' name='no_catalog' value='no_catalog' $no_catalog_checked> No Catalog</td><td>no_catalog (not used)</td></tr>
<tr><td><input type='checkbox' id='hold_override' name='hold_override' value='hold_override' $hold_override_checked> Hold Override</td><td>hold_override</td></tr>
<tr><td><input type='checkbox' id='messaging' name='messaging' value='messaging' $messaging_checked> Messaging</td><td>messaging</td></tr>
<tr><td><input type='checkbox' id='assigned_advisor' name='assigned_advisor' value='assigned_advisor' $assigned_advisor_checked> Assigned Advisor</td><td>assigned_advisor</td></tr>
<tr><td><input type='checkbox' id='advisor_class_timezone' name='advisor_class_timezone' value='advisor_class_timezone' $advisor_class_timezone_checked> Advisor Class Timezone</td><td>advisor_class_timezone</td></tr>
<tr><td><input type='checkbox' id='advisor_select_date' name='advisor_select_date' value='advisor_select_date' $advisor_select_date_checked> Advisor Select Date</td><td>advisor_select_date </td></tr>
<tr><td><input type='checkbox' id='hold_reason_code' name='hold_reason_code' value='hold_reason_code' $hold_reason_code_checked> Hold Reason Code</td><td>hold_reason_code</td></tr>
<tr><td><input type='checkbox' id='class_priority' name='class_priority' value='class_priority' $class_priority_checked> Class Priority</td><td>class_priority</td></tr>
<tr><td><input type='checkbox' id='assigned_advisor_class' name='assigned_advisor_class' value='assigned_advisor_class' $assigned_advisor_class_checked> Assigned Advisor Class</td><td>assigned_advisor_class</td></tr>
<tr><td><input type='checkbox' id='promotable' name='promotable' value='promotable' $promotable_checked> Promotable</td><td>promotable</td></tr>
<tr><td><input type='checkbox' id='excluded_advisor' name='excluded_advisor' value='excluded_advisor' $excluded_advisor_checked> Excluded Advisor</td><td>excluded_advisor</td></tr>
<tr><td><input type='checkbox' id='student_survey_completion_date' name='student_survey_completion_date' value='student_survey_completion_date' $student_survey_completion_date_checked> Student Survey Completion Date</td><td>student_survey_completion_date</td></tr>
<tr><td><input type='checkbox' id='available_class_days' name='available_class_days' value='available_class_days' $available_class_days_checked> Available Class Days</td><td>available_class_days</td></tr>
<tr><td><input type='checkbox' id='intervention_required' name='intervention_required' value='intervention_required' $intervention_required_checked> Intervention Required</td><td>intervention_required</td></tr>
<tr><td><input type='checkbox' id='copy_control' name='copy_control' value='copy_control' $copy_control_checked> Copy Control</td><td>copy_control</td></tr>
<tr><td><input type='checkbox' id='first_class_choice' name='first_class_choice' value='first_class_choice' $first_class_choice_checked> First Class Choice</td><td>first_class_choice</td></tr>
<tr><td><input type='checkbox' id='second_class_choice' name='second_class_choice' value='second_class_choice' $second_class_choice_checked> Second Class Choice</td><td>second_class_choice</td></tr>
<tr><td><input type='checkbox' id='third_class_choice' name='third_class_choice' value='third_class_choice' $third_class_choice_checked> Third Class Choice</td><td>third_class_choice</td></tr>
<tr><td><input type='checkbox' id='first_class_choice_utc' name='first_class_choice_utc' value='first_class_choice_utc' $first_class_choice_utc_checked> First Class Choice_utc</td><td>first_class_choice_utc</td></tr>
<tr><td><input type='checkbox' id='second_class_choice_utc' name='second_class_choice_utc' value='second_class_choice_utc' $second_class_choice_utc_checked> Second Class Choice_utc</td><td>second_class_choice_utc</td></tr>
<tr><td><input type='checkbox' id='third_class_choice_utc' name='third_class_choice_utc' value='third_class_choice_utc' $third_class_choice_utc_checked> Third Class Choice_utc</td><td>third_class_choice_utc</td></tr>
<tr><td><input type='checkbox' id='catalog_options' name='catalog_options' value='catalog_options' $catalog_options_checked> Catalog Options</td><td>catalog_options</td></tr>
<tr><td><input type='checkbox' id='flexible' name='flexible' value='flexible' $flexible_checked> Flexible</td><td>flexible</td></tr>
<tr><td><input type='checkbox' id='date_created' name='date_created' value='date_created' $date_created_checked> Date Created</td><td>date_created</td></tr>
<tr><td><input type='checkbox' id='date_updated' name='date_updated' value='date_updated' $date_updated_checked> Date Updated</td><td>date_updated</td></tr>
</table></p>
...
<input type='radio' id='student2' name='mode_type' value='wpw1_cwa_old_student'> Old Student<br /></p>
...
add_shortcode ('student_report_generator_v2', 'student_report_generator_v2_func');
