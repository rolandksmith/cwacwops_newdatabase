/**
 * CWA Advisor Class Data Access Layer
 * 
 * Handles all database operations for advisor class records with proper
...
if ( ! class_exists( 'CWA_Advisorclass_DAL' ) ) {
    class CWA_Advisorclass_DAL {
        ...
        /**
         * Valid database columns for advisorclass table
         */
        ...
        /**
         * Insert a new advisor class record
         * 
         * @param array $data Advisor class data to insert
        ...
        public function insert( $data, $mode ) {
            ...
            if ( $result ) {
                ...
                $this->_log(
                    $clean['advisorclass_call_sign'] ?? 'UNKNOWN',
                    'create',
                    $clean,
                    $tables
                );
        ...
        /**
         * Update an existing advisor class record
         * 
         * @param int $id Advisor class ID
        ...
        /**
         * Delete an advisor class record (moves to deleted table)
         * 
         * @param int $id Advisor class ID
         * @param string $mode Database mode
        ...
        public function delete( $id, $mode ) {
            ...
            // Log the deletion
            $this->_log(
                $record['advisorclass_call_sign'] ?? 'UNKNOWN',
                'delete',
                ['id' => $id],
                $tables
            );
        ...
        /**
         * Get advisor classes with optional filtering and ordering
         * 
         ...
         */
        public function get_advisorclasses_by_order( $criteria, $orderby, $order, $mode ) {
            if ( ! $this->_validate_mode( $mode ) ) {
                return null;
            }
       ...
       /**
        ...
        private function _get_table_names( $mode ) {
            ...
            return [
                'primary' => $this->wpdb->prefix . 'cwa_advisorclass' . $suffix,
                'log'     => $this->wpdb->prefix . 'cwa_data_log' . $suffix,
                'deleted' => $this->wpdb->prefix . 'cwa_deleted_advisorclass' . $suffix
            ];
        }
         ...
         * Log database action
         * 
         * @param string $call_sign Advisor class call sign
