...
// echo "<br />REQUEST is set<br />";
	...
	if ($userRole == 'administrator') {
		...
		if ($returnInfo[0] === FALSE) {
			...
			$content	.= "<h3>Administrator Menu for $userName</h3>
				...
				<li><a href='$siteURL/cwa-view-a-student-assessment/' target='_blank'>View a Student CW Assessment</a><br /><br />
				...
				<li><a href='$siteURL/rksmith-create-student-table/' target='_blank'>RKSTEST: Create Student Table</a>
				<li><a href='$siteURL/rkstest-create-advisor-and-class-tables/' target='_blank'>RKSTEST: Create Advisor and AdvisorClass Tables</a>
				<li><a href='$siteURL/cwa-show-callsign-audit-log-for-a-semester/' target='_blank'>Show Callsign Audit Log for a Semester</a>
				</ul>
				...
				<li><a href='$siteURL/cwa-user-administration/' target='_blank'>User Administration (Take Over Acct)
				<li><a href='$siteURL/cwa-manage-advisor-class-assignments/?strpass=20' target='_blank'>Manage Advisor Class Assignments (Fake)</a>
				<li><a href='$siteURL/cwa-student-registration/' target='_blank'>Student Registration (Fake)</a><br /><br />
				<li><a href='$siteURL/cwa-advisor-class-history/' target='_blank'>Advisor Class History</a>
				<li><a href='$siteURL/cwa-show-detailed-history-for-student/' target='_blank'>Show Detailed History for Student</a>
				<li><a href='siteURL/cwa-manage-temp-data/' target='_blank'>Manage Temp Data</a>
				<li><a href='$siteURL/cwa-display-recent-reminders/' target='_blank'>Display Recent Reminders</a>
				<li><a href='$siteURL/cwa-search-sent-email-by-callsign-or-email/' target='_blank'>Search Sent Email by Callsign or Email</a>
				<li><a href='$siteURL/cwa-view-a-student-assessment/' target='_blank'>View a Student CW Assessment</a>
				...
				<li><a href='$siteURL/cwa-daily-advisor-cron-process/' target='_blank'>Daily Advisor Cron Process</a>
				<li><a href='$siteURL/cwa-daily-catalog-cron-process/' target='_blank'>Daily Catalog Cron Process</a>
				<li><a href='$siteURL/cwa-daily-student-cron/' target='_blank'>Daily Student Cron</a><br />
				<li><a href='$siteURL/cwa-list-new-usernames/' target='_blank'>List New Usernames</a>
				<li><a href='$siteURL/cwa-verify-temp-data/' target='_blank'>Verify Temp Data</a><br />
				</ul>
				...
				<li><strong>Useful Functions Any Time</strong>
					...
					<li><a href='$siteURL/cwa-student-management/?strpass=20' target='_blank'>Exclude an Advisor from being Assigned to a Student</a>
					<li><a href='$siteURL/cwa-move-student-to-different-semester/' target='_blank'>Move Student to Different Semester</a>
					<li><a href='$siteURL/cwa-student-management/?strpass=30' target='_blank'>Override Excluded Advisor</a><br />
					</ol>
				<li><strong>Useful Functions After Students Have Been Assigned</strong>
					...
					<li><a href='$siteURL/cwa-student-management/?strpass=80' target='_blank'>Find Possible Students for an Advisor's Class</a>
					<li><a href='$siteURL/cwa-student-management/?strpass=90' target='_blank'>Assign a Student to an Advisor regardless</a>
					<li><a href='$siteURL/cwa-student-management/?strpass=85' target='_blank'>Verify One or More Students</a><br /><br />
					</ol>
				</ul>
	...
	if ($userRole == 'advisor' || $userRole == 'administrator') {
		...
		// get and display the user_master information			
		$result				= FALSE;
		$reason				= "";
		$user_id 			= 0;
		...
		if ($doDebug) {
			echo "result from get_user_master_data:<br /><pre>";
			print_r($dataResult);
			echo "</pre><br />";
		}
		// unpack the data
		...
		if ($result === FALSE) {
			...
			for ($ii=0;$ii<$count;$ii++) {
				...
				$last_name			= no_magic_quotes($user_last_name);
			}
			...
			if ($user_timezone_id == 'XX') {
				...
				$content	.= "<p><b>CRITICAL!</b> There are multiple timezone identifiers for your 
								location. Please click <a href='$siteURL/cwa-display-and-update-user-master-information/?strpass=3&inp_callsign=$userName' 
				...
				$content	.= "<p>Click <a href='$siteURL/cwa-display-and-update-user-master-information/?strpass=3&inp_callsign=$userName' 
	...
	$result			= write_joblog_func("Program List|$nowDate|$nowTime|$userName|Time|$thisStr|$strPass: $elapsedTime",$doDebug);
	if ($result == 'FAIL') {
